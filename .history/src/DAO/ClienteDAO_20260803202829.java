...
public class ClienteDAO{
    ...
    public void read() throws SQLException{
        ...
        while (rs.next()) {
            System.out.printf("Cliente:\n\tID: %d\n\tNome: %s\n\tCPF: %s\n\tTelefone: %s\n\tEmail: %s\n\tCEP: %s\n\tSenha: %s\n\tID Endereço: %d", rs.getInt("id_cliente"), rs.getString("nome_cliente"), rs.getString("cpf_cliente"), rs.getString("telefone_cliente"), rs.getString("email_cliente"), rs.getString("cep_cliente"), rs.getString("senha"), rs.getInt("id_endereco"));
        }
    }
    ...
    public Cliente getCliente(int id) throws SQLException, CpfInvalidoException, TelefoneInvalidoException , SenhaInvalidaException , CepInvalidoException , ValorInvalidoException {
        ...
        while (rs.next()) {
            ...
            return new Cliente(id, rs.getString("nome_cliente"), rs.getString("cpf_cliente"), rs.getString("telefone_cliente"), rs.getString("email_cliente"), rs.getString("cep_cliente"), rs.getString("senha"), enderecoDAO.getEndereco(rs.getInt("id_endereco")));
        }
        return null;
    }
}
