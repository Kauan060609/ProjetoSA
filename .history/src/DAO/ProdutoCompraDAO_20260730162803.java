...
public class ProdutoCompraDAO {
    ...
    public void update(ProdutoCompra pc ) throws SQLException{
        String sql = "UPDATE produto_compra SET quantidade_produto = ? , valor_unitario = ? , id_compra =  ? , id_produto = ? WHERE id_produto_compra = ? ";
        PreparedStatement ps = conn.prepareStatement(sql);
        ps.setInt(1, pc.getQuantidade_produto());
        ps.setDouble(2, pc.getValor_unitario());
        ps.setInt(3, pc.getProduto().getId_produto());
    ...
    public void delete(int id) throws SQLException{
        ...
        String sql = "DELETE FROM produto_compra WHERE id ="+id;
    ...
    public ProdutoCompgitra getProdutoCompra(int id) throws SQLException , ValorInvalidoException , CepInvalidoException , SenhaInvalidaException , CpfInvalidoException , TelefoneInvalidoException{
